Given(/^I am a professional and wrofile$/) do
  visit root_path
end

When(/^I click ohome page$/) do
  click_on "Register Your Business"
end

Then(/^I should be ablee username anto register$/) do
  fill_in "email", :with => 'fashionxt101@gmail.com'
  fill_in "password", :with => 'Abc123!'
  fill_in "confirm", :with => 'Abc123!'
end

And(/^I should be r tha entry page$/) do
  click_button "commit"
  expect(current_path).to include('general_info/new')
end


Given(/^I am a professioto enter personal data$/) do
  visit root_path
  click_on "Register Your Business"
...
When(/^I submitted all thpersonal information$/) do
...
Then(/^After saveional detail page and provide information and submit$/) do
...
And(/^I will be rediretail page$/) do
