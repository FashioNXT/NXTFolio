...
Devise.setup do |config|
  ...
  config.omniauth :facebook, ENV['facebook_client_id'], ENV['facebook_client_secret'],  {:scope => 'public_profile,email', :client_options => {:ssl => {:ca_file => '/usr/lib/ssl/certs/ca-certificates.crt'}}}
